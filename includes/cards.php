        ...
        "modal" => [
            ...
            "modalDetail" => function($conn, $id) {
                ...
                <div class="flex flex-col w-full gap-4">
                    ...
                    <p class="text-center text-sm text-neutral-800">A subject is missing? <span><a href="selectSubjects" class="font-semibold text-blue-400 border-b border-dotted border-b-blue-400">Check Here</a></span>, to see which one you omitted.</p>
                </div>
                <?php
...
function renderCards($cards, $category, $conn, $id, $class_name) {
