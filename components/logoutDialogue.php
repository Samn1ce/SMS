...
function renderLogoutDialogue(
    ...
    echo '
        ...
        >
            ...
            <div x-show="open" x-transition.opacity.duration.300ms class="bg-zinc-100/20 fixed z-30 h-screen top-0 left-0 w-full flex justify-center items-center backdrop-blur-sm p-5">
