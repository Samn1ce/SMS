    ...
    switch($name) {
        case 'email':
            ...
            <svg xmlns="http://www.w3.org/2000/svg" 
                ...
                height="16" 
                fill="currentColor" 
                class="bi bi-envelope-at ' . htmlspecialchars($class) . '" 
                viewBox="0 0 16 16"
            >
        ...
        case 'password':
            echo '
                <svg xmlns="http://www.w3.org/2000/svg" 
                    ...
                    height="16" 
                    fill="currentColor" 
                    class="bi bi-lock ' . htmlspecialchars($class) . '" 
                    viewBox="0 0 16 16"
                >
        ...
        case 'exclamation':
            echo '
                <svg xmlns="http://www.w3.org/2000/svg" 
                    ...
                    height="16" 
                    fill="currentColor" 
                    class="bi bi-exclamation-circle-fill '. htmlspecialchars($class) .'" 
                    viewBox="0 0 16 16"
                >
        ...
        case 'name':
            echo '
                <svg xmlns="http://www.w3.org/2000/svg" 
                    ...
                    height="16" 
                    fill="currentColor" 
                    class="bi bi-person ' . htmlspecialchars($class) . '" 
                    viewBox="0 0 16 16"
                >
        ...
        case 'person':
            echo '
                <svg xmlns="http://www.w3.org/2000/svg" 
                    ...
                    height="16" 
                    fill="currentColor" 
                    class="bi bi-person-badge ' . htmlspecialchars($class) . '" 
                    viewBox="0 0 16 16"
                >
        ...
        case 'grade':
            echo '
                <svg xmlns="http://www.w3.org/2000/svg" 
                    ...
                    height="16" 
                    fill="currentColor" 
                    class="bi bi-mortarboard '. htmlspecialchars($class) . '" 
                    viewBox="0 0 16 16"
                >
            ...
            case 'subjects':
                echo '
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        height="16" 
                        fill="currentColor" 
                        class="bi bi-book-half '. htmlspecialchars($class) .'" 
                        viewBox="0 0 16 16"
                    >
            ...
            case 'fees':
                echo '
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        height="16" 
                        fill="currentColor" 
                        class="bi bi-wallet2 '. htmlspecialchars($class) .'" 
                        viewBox="0 0 16 16"
                    >
            ...
            case 'termsCompleted':
                echo '
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        height="16" 
                        fill="currentColor" 
                        class="bi bi-list-nested '. htmlspecialchars($class) .'" 
                        viewBox="0 0 16 16"
                    >
            ...
            case 'personProfile':
                echo '
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        height="16" 
                        fill="currentColor" 
                        class="bi bi-person-fill '. htmlspecialchars($class) .'" 
                        viewBox="0 0 16 16"
                    >
            ...
            case 'gender':
                echo '
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        height="16" 
                        fill="currentColor" 
                        class="bi bi-gender-neuter '. htmlspecialchars($class) .'" 
                        viewBox="0 0 16 16"
                    >
            ...
            case 'date':
                echo '
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        height="16" 
                        fill="currentColor" 
                        class="bi bi-calendar-week '. htmlspecialchars($class) .'" 
                        viewBox="0 0 16 16"
                    >
            ...
            case 'hammer':
                echo '
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        height="16" 
                        fill="currentColor" 
                        class="bi bi-hammer '. htmlspecialchars($class) .'" viewBox="0 0 16 16">
            ...
            case 'new':
                echo '
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        height="16" 
                        fill="currentColor" 
                        class="bi bi-journal-plus '.htmlspecialchars($class).'" 
                        viewBox="0 0 16 16"
                    >
            ...
            case 'dashboard':
                echo '
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        height="16" 
                        fill="currentColor" 
                        class="bi bi-grid-1x2-fill '.htmlspecialchars($class).'" 
                        viewBox="0 0 16 16"
                    >
            ...
            case 'assignment':
                echo '
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        height="18" 
                        fill="currentColor" 
                        class="bi bi-journal-medical '.htmlspecialchars($class).'" 
                        viewBox="0 0 16 16"
                    >
            ...
            case 'result':
                echo '
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        height="18" 
                        fill="currentColor" 
                        class="bi bi-3-square '.htmlspecialchars($class).'" 
                        viewBox="0 0 16 16"
                    >
            ...
            case 'logout':
                echo '
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        height="18" 
                        fill="currentColor" 
                        class="bi bi-box-arrow-left '.htmlspecialchars($class).'" 
                        viewBox="0 0 16 16"
                    >
