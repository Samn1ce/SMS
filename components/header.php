<?php
    function renderHeader($student_name, $role) {
        echo '
            <header class="w-full border-b">
                <div class="w-full mx-auto">
                    <div class="mx-auto w-11/12 lg:w-10/12 flex justify-between p-2">
                        ...
                        <a href="studentProfile.php?id=<?= $id ?>" class="hidden md:flex flex-col justify-end items-end cursor-pointer p-2 hover:bg-zinc-300 duration-300 transition-all">
