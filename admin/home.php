...
<body>
    <div class="w-full h-screen flex">
        ...
        <main class="w-full h-full overflow-auto bg-[#FAFAFC]">
            <header class="px-10 py-6 bg-white">
                <div class="mx-auto max-w-7xl flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div x-data="{ open: false }" class="relative flex items-center gap-3 ml-2 cursor-pointer">
            ...
            <div class="mx-auto max-w-7xl px-10 pb-10 flex-1">
                <div class="bg-[#EBE7FF] rounded-3xl p-8 mt-6 relative border border-zinc-200/60 overflow-hidden flex items-center h-[200px]">
                    <div class="z-10 relative">
                        <h2 class="text-4xl font-serif text-[#1F1B3E] font-bold mb-3">Hi, <?= formatName($firstname) ?></h2>
