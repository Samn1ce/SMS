                ...
                <div class="flex flex-col items-center w-full rounded-3xl p-5 bg-neutral-50 border border-neutral-100">
                    ...
                    <div class="flex flex-col justify-center items-center w-10/12">
                        ...
                        <div class="flex gap-4 mt-3 w-11/12">
                            <a href="logout.php" class="w-1/2 text-center px-4 py-1 rounded-xl bg-blue-600 text-zinc-100 font-semibold">Yes</a>
                            <a x-on:click="open = false" href="#" class="font-semibold w-1/2 border-zinc-400 border-2 px-4 rounded-xl text-center">No</a>
                        </div>
                    </div>
                </div>
            </div>
